...
const linkRedirectAddBot = `https://discord.com/api/oauth2/authorize?response_type=token&client_id=${CLIENT_ID}&permissions=1635070044278&guild_id={guildID}&redirect_uri=${protocol}%3A%2F%${start}${ends}%2F{lang}%2Fdashboard&response_type=code&scope=bot%20applications.commands%20identify%20guilds`
